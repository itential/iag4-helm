...
| applicationSettings.ansibleVenvEnabled | bool | `true` | Enables Ansible virtual environments. Independent of ansibleEnabled. |
...
| applicationSettings.bindAddress | string | `""` | Override the IAG bind address. Defaults to pod IP via downward API when empty. Set to "0.0.0.0" to bind on all interfaces. |
